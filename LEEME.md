...
- [x] **Kit de piloto**: evaluación pre/post integrada (⚙️ → Evaluación piloto, 10 preguntas con puerta docente; resultados viajan en el código MV1) + columnas Pre/Post/avance en panel docente, CSV e informe + **auto-test** (`juego/test.html`: ~30 verificaciones de integridad de datos y pantallas antes de cada clase)
